...
class HomeHashFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        context.homeViewModel.list3.list1.observe(context, Observer {
            adapter1.setList(it)
        })
        context.homeViewModel.list3.list2.observe(context, Observer {
            adapter2.setList(it)
        })
        context.homeViewModel.list3.list3.observe(context, Observer {
            adapter3.setList(it)
        })
